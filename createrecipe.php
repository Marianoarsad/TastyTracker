    ...
    if (in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            ...
            if ($sqlResult) {
                ...
                $sql2 = "INSERT INTO ingredients (ingredient, type, ammount, method, duration, heat, user_id, recipeName, recipe_id)
                        VALUES ('$ingredient', '$type', '$ammount', '$method', '$duration', '$heat', '$user_id', '$recipeName', (SELECT recipe_id FROM recipe WHERE recipeName ='$recipeName'))";
        ...
        <div class="form-window">
                ...
                <form class ="form-container" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="imageInputname-input form-input" id="images" accept=" .jpg, .jpeg, .png" placeholder="Insert recipe image" name="image">
                    </div>
                    <div class="form-group">
