...
if(isset($_POST['submit'])){
    ...
    /*Update to RECIPE TABLE*/
    $sql = "UPDATE recipe
            SET recipeName = '$recipeName', desciption = '$description'
        ...
        <div class="form-window">
                ...
                <form class ="form-container" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="name-input form-input" id="ingredient" placeholder="<?php echo"$recipeName"?>" name="recipeName">
                    </div>
                    <div class="form-group">
                        <label for ="recipeName">Description</label>
                        <input type="text" class="desc-input form-input" id="description" placeholder="<?php echo"$desc"?>'" name="description">
                    </div>
